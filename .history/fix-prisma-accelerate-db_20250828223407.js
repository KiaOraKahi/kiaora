...
async function fixPrismaAccelerateDatabase() {
  try {
    ...
    if (!hasAchievements || !hasProfession) {
      ...
      console.log('\n✅ Prisma Accelerate database schema updated successfully!');
    } else {
    ...
    try {
      ...
      console.log('\n🎉 Prisma Accelerate database is now ready for celebrity applications!');
    ...
    console.error('❌ Error fixing Prisma Accelerate database:', error);
  } finally {
    await prisma.$disconnect();
  }
}

fixPrismaAccelerateDatabase();
