...
export async function sendSupportRequestEmail(email: string, name: string, ticketNumber: string, subject: string, category: string) {
  try {
    const info = await transporter.sendMail({
      from: `"Kia Ora Kahi Support" <${process.env.EMAIL_USER}>`,
      to: email,
      ...
      html: `
        <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
          ...
          <div style="background: linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%); padding: 30px; border-radius: 10px; text-align: center;">
            <h2 style="color: white; margin: 0 0 20px 0;">Support Request Received</h2>
            <p style="color: white; margin: 0 0 25px 0;">Hi ${name},</p>
            <p style="color: white; margin: 0 0 25px 0;">Thank you for contacting Kia Ora Kahi support. We've received your request and will get back to you within 24 hours.</p>
            
            <div style="background: rgba(255,255,255,0.2); padding: 20px; border-radius: 5px; margin: 20px 0; text-align: left;">
              <p style="color: white; margin: 0 0 10px 0;"><strong>Ticket Number:</strong> ${ticketNumber}</p>
              <p style="color: white; margin: 0 0 10px 0;"><strong>Subject:</strong> ${subject}</p>
              <p style="color: white; margin: 0 0 10px 0;"><strong>Category:</strong> ${category}</p>
              <p style="color: white; margin: 0 0 0 0;"><strong>Status:</strong> Open</p>
            </div>
          </div>
          
          <div style="margin-top: 20px; text-align: center; color: #666;">
            <p>If you need immediate assistance, please call us at +1 (555) 123-4567</p>
            <p>You can also track your ticket status by visiting our support portal.</p>
          </div>
        </div>
      `,
      text: `
        ...
        Thank you for contacting Kia Ora Kahi support. We've received your request and will get back to you within 24 hours.
