...
import { CheckCircle, XCircle, Eye, Mail, DollarSign, Calendar, FileText, Loader2, RefreshCw } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={fetchApplications} variant="outline" className="bg-white/10 border-white/20 text-white">
