...
// Sample content data - in real app, this would come from database
const sampleContent: ContentItem[] = [
  {
    ...
    type: "Title",
    status: "active",
    updatedAt: "7/25/2025, 3:26:40 PM",
  ...
  },
  {
    ...
    type: "Description",
    status: "active",
    updatedAt: "7/25/2025, 2:15:30 PM",
  ...
  },
  {
    ...
    type: "Title",
    status: "active",
    updatedAt: "7/24/2025, 1:45:20 PM",
  ...
  },
  {
    ...
    type: "Title",
    status: "active",
    updatedAt: "7/23/2025, 4:30:15 PM",
  ...
  const handleEditContent = () => {
    ...
    const updatedContent = content.map(item => 
      item.id === editingContent.id 
        ? { ...editingContent, updatedAt: new Date().toLocaleString() }
        : item
    )
