...
export default function CelebrityPayoutDashboard() {
  ...
  const exportToExcel = (data: any[], filename: string, sheetName: string = 'Sheet1') => {
    ...
    // Create Excel XML content (XLSX format)
    const excelContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
    ...
    // Create a more compatible Excel format that opens in Microsoft Excel
    const csvContent = [
