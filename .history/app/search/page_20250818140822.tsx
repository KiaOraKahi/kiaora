...
import { Search, Star, Clock, SlidersHorizontal, X, ArrowUpDown, Grid3X3, List, Sparkles } from "lucide-react"
...
const celebrities = [
  {
    ...
    tags: ["Hollywood", "Comedy", "Drama", "Oscar Winner"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=300",
    bio: "Grammy and Oscar-winning singer, songwriter, and producer",
    tags: ["R&B", "Soul", "Piano", "Grammy Winner"],
    availability: "Available",
    completionRate: 100,
    featured: true,
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=300",
    bio: "World-renowned life coach and motivational speaker",
    tags: ["Life Coach", "Business", "Success", "Motivation"],
    availability: "Busy",
    completionRate: 95,
    featured: true,
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=300",
    bio: "YouTube sensation known for philanthropy and viral challenges",
    tags: ["YouTube", "Philanthropy", "Gaming", "Viral"],
    availability: "Available",
    completionRate: 97,
    featured: true,
  },
  {
    ...
    tags: ["Media", "Inspiration", "Books", "Philanthropy"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=300",
    bio: "Canadian actor known for Deadpool, Green Lantern, and witty humor",
    tags: ["Comedy", "Action", "Marvel", "Canadian"],
    availability: "Available",
    completionRate: 92,
    featured: false,
  },
  {
    ...
    tags: ["Tennis", "Champion", "Inspiration", "Sports"],
    availability: "Available",
    completionRate: 96,
    featured: true,
  },
  {
    ...
    tags: ["Stand-up", "Comedy", "Movies", "Entertainment"],
    availability: "Available",
    completionRate: 94,
    featured: false,
  },
