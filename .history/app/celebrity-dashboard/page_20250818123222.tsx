...
export default function CelebrityDashboard() {
  ...
  const getFilteredOrders = () => {
    ...
    if (orderFilter === "pending_approval")
      return allOrders.filter((order) => order.approvalStatus?.toLowerCase() === "pending_approval")
    if (orderFilter === "approved") return allOrders.filter((order) => order.approvalStatus?.toLowerCase() === "approved")
    if (orderFilter === "declined") return allOrders.filter((order) => order.approvalStatus?.toLowerCase() === "declined")
    return allOrders
  }
