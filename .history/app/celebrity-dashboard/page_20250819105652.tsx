  ...
  const exportPaymentsPDF = async () => {
    try {
      ...
      const monthlyData = payments.reduce((acc: any, payment: any) => {
        ...
        acc[month].total += payment.amount / 100
        acc[month].count += 1
        return acc
      }, {})
      ...
      // Summary
      const totalEarnings = payments.reduce((sum: number, p: any) => sum + (p.amount / 100), 0)
      pdf.setFontSize(14)
      pdf.text('Summary', 20, 50)
      pdf.setFontSize(12)
      pdf.text(`Total Earnings: $${totalEarnings.toFixed(2)}`, 20, 60)
      pdf.text(`Total Orders: ${payments.length}`, 20, 70)
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-purple-200 text-sm font-medium">Total Earnings</p>
                             ...
                             ${((stats.totalEarnings || 0) / 100).toLocaleString()}
                           </p>
                           <div className="flex items-center gap-2 mt-1">
                             <span className="text-xs text-green-400">
                               ${((stats.orderEarnings || 0) / 100).toLocaleString()} bookings
                             </span>
                             {stats.tipEarnings > 0 && (
                               <span className="text-xs text-yellow-400">
                                 +${((stats.tipEarnings || 0) / 100).toLocaleString()} tips
                               </span>
                             )}
                           </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-purple-200 text-sm font-medium">This Month</p>
                                                     <p className="text-2xl font-bold text-white">
                             ${((stats.monthlyEarnings || 0) / 100).toLocaleString()}
                           </p>
                          <div className="flex items-center gap-2 mt-1">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-purple-200 text-sm font-medium">Tips Received</p>
                             ...
                             ${((stats.tipEarnings || 0) / 100).toLocaleString()}
                           </p>
                           <p className="text-xs text-purple-400 mt-1">
                             This month: ${((stats.monthlyTipEarnings || 0) / 100).toLocaleString()}
                           </p>
                        </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-2xl font-bold text-green-400">
                        ${((stats?.orderEarnings || 0) / 100).toLocaleString()}
                      </p>
                        ...
                        >
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="text-right">
                                 ...
                                 <p className="text-sm text-white">Total: ${(request.totalEarnings / 100).toLocaleString()}</p>
                               </div>
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="text-right">
                                                         <div className="space-y-1">
                               <p className="text-lg font-bold text-green-400">
                                 ${((order.celebrityAmount || 0) / 100).toLocaleString()}
                               </p>
                               {order.tipAmount > 0 && (
                                 <p className="text-sm font-semibold text-yellow-400">
                                   +${(order.tipAmount / 100).toLocaleString()} tip
                                 </p>
                               )}
                               <p className="text-sm text-white">Total: ${(order.totalEarnings / 100).toLocaleString()}</p>
                             </div>
                            <p className="text-purple-200 text-sm mt-2">
