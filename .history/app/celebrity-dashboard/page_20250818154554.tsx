                                ...
                                {request.tips.map((tip) => (
                                  ...
                                  >
                                    ...
                                    {tip.message && <p className="text-white text-sm mt-2">{tip.message}</p>}
                                                     ...
                                                     {(request.status?.toLowerCase() === "pending" || request.approvalStatus?.toLowerCase() === "pending_approval") && request.status?.toLowerCase() !== "confirmed" && request.approvalStatus?.toLowerCase() !== "approved" && (
