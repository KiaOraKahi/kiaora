...
export async function POST(
  ...
  try {
    ...
    // This will automatically transfer the money to the celebrity's account
    const paymentIntent = await stripe.paymentIntents.create({
      ...
      metadata: {
        ...
        transferType: "automatic_destination_charge",
      },
    })

    // Update order status and store the PaymentIntent ID
    // Status is COMPLETED but transfer is pending until webhook confirms
