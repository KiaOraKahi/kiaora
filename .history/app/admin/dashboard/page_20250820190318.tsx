            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-xl">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-white">{mockStats.totalCelebrities}</div>
                    <div className="flex items-center text-xs text-green-400">
                      <ArrowUpRight className="w-3 h-3 mr-1" />
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-xl">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-white">{mockStats.totalOrders.toLocaleString()}</div>
                    <div className="flex items-center text-xs text-green-400">
                      <ArrowUpRight className="w-3 h-3 mr-1" />
                      +{mockStats.orderGrowth}% from last month
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-xl">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-white">${mockStats.totalRevenue.toLocaleString()}</div>
                    <div className="flex items-center text-xs text-green-400">
                      <ArrowUpRight className="w-3 h-3 mr-1" />
