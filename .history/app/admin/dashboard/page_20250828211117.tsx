...
export default function AdminDashboard() {
  ...
  const exportBookingsData = async () => {
    ...
    try {
      ...
      // Add table
      autoTable(doc, {
        head: [['Order #', 'Customer', 'Celebrity', 'Amount', 'Status', 'Payment', 'Created']],
        body: tableData,
        startY: 50,
        styles: {
          fontSize: 8,
    ...
    <div className="min-h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-6 bg-white/10 border-white/20">
              ...
              <TabsTrigger value="platform-fees" className="text-white data-[state=active]:bg-purple-500">
                <DollarSign className="w-4 h-4 mr-2" />
                Platform Fees
              </TabsTrigger>
              <TabsTrigger value="content-management" className="text-white data-[state=active]:bg-purple-500">
                <FileText className="w-4 h-4 mr-2" />
                Content
              </TabsTrigger>
              <TabsTrigger value="service-management" className="text-white data-[state=active]:bg-purple-500">
            ...
            <TabsContent value="content-management" className="space-y-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-400 mb-2">Content Management</h3>
            ...
            <TabsContent value="service-management" className="space-y-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-400 mb-2">Service Management</h3>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-white/80">Joined</label>
                  <p className="text-white">{new Date(selectedUser.joined).toLocaleDateString()}</p>
                </div>
        ...
        {showViewBookingModal && selectedBooking && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-white/80">Customer</label>
                  <p className="text-white">{selectedBooking.customer}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-white/80">Celebrity</label>
        ...
        {showEditBookingModal && selectedBooking && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg p-6 w-full max-w-md">
              <h3 className="text-xl font-bold text-white mb-4">Edit Booking Status</h3>
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-white/80">Customer</label>
                  <p className="text-white">{selectedBooking.customer}</p>
