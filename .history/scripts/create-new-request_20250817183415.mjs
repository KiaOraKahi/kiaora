  ...
  try {
    ...
    const booking = await prisma.booking.create({
      data: {
        ...
        recipientName: 'Michael Wilson',
        occasion: 'Birthday',
        message: 'Please create a special birthday message for my husband Michael. He loves your movies and would be thrilled to receive a personalized message from you!',
        instructions: 'Please make it extra special and mention how much he loves your work!',
        status: 'PENDING',
