...
async function createDummyData() {
  try {
    ...
    // Create dummy tips for the last 6 months
    const tipsData = [
      { amount: 500, message: "Amazing video! Thank you!", createdAt: new Date('2024-01-15') },
      { amount: 750, message: "Perfect for my daughter's birthday!", createdAt: new Date('2024-01-22') },
      { amount: 300, message: "Love your work!", createdAt: new Date('2024-02-10') },
      { amount: 1000, message: "Incredible performance!", createdAt: new Date('2024-02-28') },
      { amount: 400, message: "Thank you so much!", createdAt: new Date('2024-03-05') },
      { amount: 600, message: "You're the best!", createdAt: new Date('2024-03-15') },
      { amount: 800, message: "Amazing talent!", createdAt: new Date('2024-04-01') },
      { amount: 350, message: "Perfect timing!", createdAt: new Date('2024-04-12') },
      { amount: 900, message: "Absolutely fantastic!", createdAt: new Date('2024-05-03') },
      { amount: 450, message: "Thank you Emma!", createdAt: new Date('2024-05-20') },
      { amount: 700, message: "Incredible video!", createdAt: new Date('2024-06-08') },
      { amount: 550, message: "You made my day!", createdAt: new Date('2024-06-25') },
    ]
    ...
    for (const tipData of tipsData) {
      await prisma.tip.create({
        data: {
          ...
          updatedAt: tipData.createdAt
        }
      })
    }
    
    // Create dummy orders with bookings
