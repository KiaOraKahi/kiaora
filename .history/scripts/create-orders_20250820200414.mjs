      ...
      data: {
        ...
        booking: {
          create: {
            ...
            user: {
              connect: { id: users.length > 1 ? users[1].id : users[0].id }
            },
            celebrity: {
              connect: { id: celebrities.length > 1 ? celebrities[1].id : celebrities[0].id }
            }
          }
        }
      }
      ...
      data: {
        ...
        booking: {
          create: {
            ...
            celebrity: {
              connect: { id: celebrities.length > 2 ? celebrities[2].id : celebrities[0].id }
            }
          }
        }
      }
