    ...
    reviews: [
      {
        ...
        date: "2024-01-10",
        comment:
          "Emma's message was absolutely perfect! She captured exactly what I wanted to say and made my sister's birthday so special. The video quality was amazing and she delivered it right on time.",
        verified: true,
        occasion: "Birthday",
      },
      {
        ...
        date: "2024-01-08",
        comment:
          "Incredible experience! Emma was so genuine and personal in her message. My wife was moved to tears. Worth every penny and more!",
        verified: true,
      ...
      },
      {
        ...
        date: "2024-01-05",
        comment:
          "Great message from Emma! She was funny and sweet. Only giving 4 stars because it took a bit longer than expected, but the quality was excellent.",
        verified: true,
        occasion: "Graduation",
      },
    ],
    ...
    reviews: [
      {
        ...
        date: "2024-01-12",
        comment:
          "John's message was absolutely magical! His voice and the way he personalized it for my wife's birthday was incredible. She was speechless and so touched. This is a memory we'll cherish forever.",
        verified: true,
        occasion: "Birthday",
      },
      {
        ...
        date: "2024-01-09",
        comment:
          "Incredible experience! John's message was so personal and heartfelt. My husband was moved to tears on our anniversary. The quality and timing were perfect.",
        verified: true,
        occasion: "Anniversary",
      },
    ],
    ...
    reviews: [
      {
        ...
        date: "2024-01-11",
        comment:
          "Tony's message was absolutely life-changing! His words gave me the motivation I needed to take my business to the next level. The energy and passion in his delivery was incredible.",
        verified: true,
      ...
      },
      {
        ...
        date: "2024-01-07",
        comment:
          "Great motivational message from Tony! He really personalized it for my situation and gave me actionable advice. The delivery was powerful and inspiring.",
        verified: true,
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      if (celebrity) {
        ...
        const formattedCelebrity = {
          ...
          image:
            celebrity.user.image || "/placeholder.svg?height=400&width=400",
          coverImage:
          ...
          longBio:
            celebrity.longBio ||
            celebrity.bio ||
            "Professional celebrity with years of experience",
          tags: celebrity.tags || [],
          ...
          sampleVideos: celebrity.sampleVideos.map((video) => ({
            ...
            title: video.title,
            thumbnail:
              video.thumbnail || "/placeholder.svg?height=200&width=300",
    ...
    const mockCelebrity =
      mockCelebrities[celebrityId as keyof typeof mockCelebrities];
