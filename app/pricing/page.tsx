...
const pricingTiers = [
  {
    name: "Business Endorsements",
    price: null,
    originalPrice: null,
    description: "Professional shoutouts and endorsements for your brand",
    color: "from-purple-500 to-pink-500",
    popular: true,
    features: [
      "1–2 minute endorsement",
      "4K Ultra HD quality",
    ...
    notIncluded: ["ASAP delivery (12h)"],
    celebrities: "Top creators and industry leaders",
  },
  {
    name: "Quick Shout-Outs",
    price: 99,
    originalPrice: null,
    description: "Fast personal shout-outs for any occasion",
    color: "from-blue-500 to-cyan-500",
    popular: false,
    features: [
      "30–60 second message",
      "HD quality (1080p)",
      "Standard delivery (1–3 days)",
      "Digital download",
      "Personal use license",
    ],
    notIncluded: ["Commercial use", "Extended length", "4K quality"],
    celebrities: "Influencers and rising stars",
  },
  {
    name: "Motivational Messages",
    price: null,
    originalPrice: null,
    description: "Inspiring words tailored to your goals",
    ...
    notIncluded: ["Commercial use"],
    celebrities: "Motivational speakers and thought leaders",
  },
];
