...
import { Star, Users, Award, Globe, Heart, Zap, Shield, Sparkles } from "lucide-react"
...
const stats = [
  ...
  { number: "50K+", label: "Messages Delivered", icon: <Heart className="w-6 h-6" /> },
...
const values = [
  {
    ...
    description: "We believe in creating genuine moments between fans and their favorite celebrities.",
  ...
  },
  {
    ...
    title: "Innovation",
    description: "We're constantly evolving to bring you the best celebrity experience platform.",
    color: "from-purple-500 to-indigo-500",
  },
  {
    icon: <Globe className="w-8 h-8" />,
    title: "Global Reach",
    description: "Connecting fans worldwide with celebrities from every corner of the entertainment industry.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl sm:text-2xl text-purple-200 max-w-4xl mx-auto leading-relaxed">
              We're on a mission to make celebrity interactions accessible, authentic, and unforgettable for fans around
              the world.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-purple-200 leading-relaxed">
                <p>
                  Kia Ora was born from a simple observation: fans desperately wanted to connect with their heroes, but
                  the barriers seemed insurmountable. Traditional meet-and-greets were expensive, exclusive, and often
                  disappointing.
                </p>
                <p>
                  We envisioned a world where a birthday message from your favorite actor, a pep talk from a sports
                  legend, or business advice from an entrepreneur was just a few clicks away. Not as a distant dream,
                  but as an accessible reality.
                </p>
                <p>
                  Today, we're proud to have facilitated thousands of magical moments, turning fan dreams into cherished
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Our Values</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">
              The passionate individuals working to make celebrity connections accessible to everyone.
            </p>
          </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-lg border border-white/20 rounded-3xl p-12">
            ...
            <p className="text-xl text-purple-200 mb-8 max-w-2xl mx-auto">
              Whether you're a fan looking for that perfect message or a celebrity wanting to connect with your
              audience, we're here to make it happen.
            </p>
