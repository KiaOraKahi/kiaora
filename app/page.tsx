...
import { MessageCircle, Video, Briefcase, Sparkles, Zap, Laugh, Gift, Clock, DollarSign, Shield, ArrowUpRight, Search, CreditCard, ArrowRight, ChevronLeft, ChevronRight, Star } from "lucide-react"
  ...
  useEffect(() => {
    const fetchFeaturedCelebrities = async () => {
      try {
        ...
        const response = await fetch("/api/celebrities/featured?limit=6")
        ...
        console.log("Fetched featured celebrities:", data.celebrities?.length || 0)
      } catch (error) {
        console.error("Error fetching featured celebrities:", error)
        // Fallback to static data if API fails
        setFeaturedCelebrities([
          { id: "1", name: "Emma Bloom", image: "/talents/1.jpeg" },
          { id: "2", name: "John Legend", image: "/talents/2.jpg" },
          { id: "3", name: "Amy Schumer", image: "/talents/3.jpg" },
          { id: "4", name: "PewDiePie", image: "/talents/4.jpg" },
          { id: "5", name: "Gary Vaynerchuk", image: "/talents/5.jpg" },
          { id: "6", name: "Oprah Winfrey", image: "/talents/6.jpg" }
        ])
      } finally {
