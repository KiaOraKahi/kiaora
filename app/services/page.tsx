...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "The quick shout-out from Kevin Hart made my daughter's day! So much energy and fun!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Tony Robbins' motivational message helped me through a tough time. Worth every penny!",
    avatar: "/placeholder.svg?height=60&width=60",
  },
  {
    name: "Lisa Rodriguez",
    ...
    rating: 5,
    comment:
      "The business endorsement boosted our product launch beyond expectations. Amazing service!",
    avatar: "/placeholder.svg?height=60&width=60",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-yellow-200 max-w-4xl mx-auto leading-relaxed">
              From quick shout-outs to live interactions, discover the perfect
              talent service for your needs.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-yellow-200 max-w-3xl mx-auto">
              Real stories from satisfied customers who've experienced the magic
              of talent messages.
            </p>
          </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-yellow-500/20 to-purple-500/20 backdrop-blur-lg border border-white/20 rounded-3xl p-12">
            ...
            <p className="text-xl text-yellow-200 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied customers who have created
              unforgettable moments with their favourite talent.
            </p>
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/20">
                <div>
                  <h3 className="text-xl font-bold text-white">
                    {selectedSample.celebrity}
                  </h3>
                  <p className="text-yellow-200">
                    Sample {selectedSample.service}
                  </p>
                </div>
                <Button
                  variant="ghost"
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const service = services.find((s) =>
                        s.samples.some(
                          (sample) =>
                            sample.celebrity === selectedSample.celebrity
                        )
                      );
                      if (service) {
                        handleServiceSelect(service.id);
