...
const steps = [
  {
    ...
    description:
      "Explore our list of celebrities across entertainment, sports, business, social media and more.",
    details: [
  ...
  },
  {
    ...
    description:
      "Tell us exactly what you want your celebrity to say and who it's for.",
    details: [
  ...
  },
  {
    ...
    description:
      "Get your personalised video message within the promised timeframe.",
    details: [
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-purple-200 max-w-4xl mx-auto leading-relaxed">
              Getting a personalised message from your favourite celebrity is
              easier than you think. Here's how it works.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        >
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-lg border border-white/20 rounded-3xl p-12">
            ...
            <p className="text-xl text-purple-200 mb-8 max-w-2xl mx-auto">
              Join thousands of happy customers who have received amazing
              personalised messages from their favourite celebrities.
            </p>
            <Button
              size="lg"
