                          ...
                          {services.map((service) => (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className="text-purple-400">{getServiceIcon(service.icon)}</div>
                                <div>
                                  <span className="text-white font-semibold">{service.title || service.name}</span>
                                  <p className="text-purple-300 text-sm">
                                    {service.duration} • {service.deliveryTime}
                                  </p>
                                </div>
                              </div>
                              <span className="text-2xl font-bold text-purple-300">${service.startingPrice || service.basePrice}</span>
                            </div>
                          ))}
                        </div>
                      ) : (
