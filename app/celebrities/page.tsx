...
export default function TalentsPage() {
  ...
  const [pagination, setPagination] = useState<
    CelebritiesResponse["pagination"] | null
  >(null);
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-yellow-200 max-w-4xl mx-auto leading-relaxed">
              Connect with your favourite stars, influencers, and personalities
              for personalized video messages and live interactions.
            </p>
          </motion.div>
        </div>
      </section>
                  ...
                  >
                    <Card className="bg-white/5 border-white/10 backdrop-blur-lg hover:bg-white/10 transition-all duration-300 h-full">
                      <CardContent className="p-3 md:p-6">
                        ...
                        <p className="text-yellow-200 text-xs md:text-sm mb-2 md:mb-3 line-clamp-2">
                          {celebrity.bio}
                        </p>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {celebrity.tags.slice(0, 3).map((tag, idx) => (
                                <Badge
                                  key={idx}
                                  variant="outline"
                                  className="text-xs bg-white/5 border-white/20 text-yellow-200"
                                >
                                  {tag}
                                </Badge>
                              ))}
